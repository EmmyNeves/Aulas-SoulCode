//Declare três variáveis chamadas nome, idade e altura. Atribua valores a elas e exiba uma frase como: "Meu nome é João, tenho 25 anos e minha altura é 1.75m."
let nome = "Emily Neves"
let idade = 22
let altura = 1.60

console.log("Meu nome é",nome, "tenho",idade, "anos, e minha altura é",altura,"m");

//Crie duas variáveis numero1 e numero2. Some os dois valores e exiba o resultado no console com a frase:"A soma é: 15" (troque 15 pelo valor real da soma).
let numero1 = 4
let numero2 = 6
...
let media = (a + b + c) / 3;
console.log(media);
//Dado os valores a = 10, b = 5 e c = 2, calcule o resultado da expressão: (a + b) * c / 2 Mostre o resultado no console.
a = 10;
b = 5;
c = 2;
...
//Crie uma variável idade e verifique se o valor é maior ou igual a 18 usando o operador de comparação. Exiba uma mensagem: "É maior de idade: true/false".
