...
//uma matriz pode armazenar vários tipos
...
console.log(alunos[alunos.length-1]); // ultimo


alunos.push ("Jaqueline"); // adiciona no fim
...
console.log(nome.replace("Java", "Type")); //boxing
